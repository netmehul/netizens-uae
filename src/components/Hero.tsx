...
export function Hero() {
  ...
  return (
    <section className="relative w-full min-h-[80vh] pt-28 pb-9 sm:pb-20 flex items-center overflow-hidden">
      ...
      <div className="max-w-[1200px] mx-auto px-4 w-full flex flex-col lg:flex-row items-center justify-between gap-5 lg:gap-8 z-10">
        {/* Left Content */}
        <div className="flex flex-col gap-6 lg:gap-10 max-w-4xl w-full">
          <h1
            ref={titleRef}
            className="text-3xl md:text-5xl lg:text-6xl md:leading-[1.1] lg:leading-snug 2xl:leading-[92px] font-sans font-bold text-carbon-black flex flex-wrap"
          >
            {renderWords(line1)}
        ...
        <div
          ref={formRef}
          className="w-full border lg:w-[424px] shrink-0 bg-white px-5 py-5 sm:py-8 rounded-[10px] shadow-xl relative overflow-hidden"
        >
